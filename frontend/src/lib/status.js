...
// Fotos enviadas voltam da API como caminho relativo (ex. "/uploads/xyz.jpg") e
// precisam ser resolvidas contra o backend, não contra a origem do frontend.
// URLs absolutas e data URIs ficam intocadas.
